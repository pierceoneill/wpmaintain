                                ...
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">
                                        ...
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                            <label class="bpa-form-label"><?php esc_html_e('Enable Searchbox', 'bookingpress-appointment-booking'); ?></label>
                                            <el-switch v-model="booking_form_settings.bpa_enable_searchbox" class="bpa-swtich-control"></el-switch>
                                        </div>
                                        
                                        <div class="bpa-sm--item">
                                            <el-select v-model="booking_form_settings.bookingpress_selected_searchbox" multiple class="bpa-form-control bpa-from-select-tab bpa_enable_searchbox" v-show="booking_form_settings.bpa_enable_searchbox" filterable collapse-tags :popper-append-to-body="false" popper-class="bpa-el-select--is-with-navbar" placeholder="<?php esc_html_e( 'Please Select', 'bookingpress-appointment-booking' ); ?>" >
                                                <el-option v-for="item_data in bookingpress_search_data_list" :label="item_data.label" :key="item_data.value" :value="item_data.value" ></el-option>
                                            </el-select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls" v-if="typeof is_gcaptcha_activated !== 'undefined' && is_gcaptcha_activated == 1">
                                        <div class="bpa-cs-sp-sub-module--separator"></div>
                                        <div class="bpa-sm--item">
                                            <h5 class="bpa-sm-sub-heading--item"><?php esc_html_e( 'Google reCaptcha Settings', 'bookingpress-appointment-booking' ); ?></h5>
                                        </div>
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">
                                        <div class="bpa-sm--item">
                                            <h5 class="bpa-sm-sub-heading--item"><?php esc_html_e( 'Date & Time Step Settings', 'bookingpress-appointment-booking' ); ?></h5>
                                        </div>
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Time slot styling', 'bookingpress-appointment-booking'); ?></label>  
                                            <el-select v-model="booking_form_settings.bookigpress_time_format_for_booking_form" class="bpa-form-control"  popper-class="bpa-el-select--is-with-navbar bpa-el-select--is-customize-left-panel">
                                                <el-option label="<?php echo sprintf( esc_html__( '%1$s to %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i', strtotime('11:00') ), date_i18n( 'H:i', strtotime('12:00') ) ) //phpcs:ignore ?>" value="1" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php echo sprintf( esc_html__( '%1$s to %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i', strtotime('11:00') ), date_i18n( 'H:i', strtotime('12:00') ) ) //phpcs:ignore ?></el-option>
                                                <el-option label="<?php echo sprintf( esc_html__( '%1$s to %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i a', strtotime('11:00') ), date_i18n( 'H:i a', strtotime('12:00') ) ) //phpcs:ignore ?>" value="2" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true" ><?php echo sprintf( esc_html__( '%1$s to %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i a', strtotime('11:00') ), date_i18n( 'H:i a', strtotime('12:00') ) ) //phpcs:ignore ?></el-option>
                                                <el-option label="<?php echo sprintf( esc_html__( '%1$s - %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i', strtotime('11:00') ), date_i18n( 'H:i', strtotime('12:00') ) ) //phpcs:ignore ?>" value="5" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php echo sprintf( esc_html__( '%1$s - %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i', strtotime('11:00') ), date_i18n( 'H:i', strtotime('12:00') ) ) //phpcs:ignore ?></el-option>
                                                <el-option label="<?php echo sprintf( esc_html__( '%1$s - %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i a', strtotime('11:00') ), date_i18n( 'H:i a', strtotime('12:00') ) ) //phpcs:ignore ?>" value="6" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php echo sprintf( esc_html__( '%1$s - %2$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i a', strtotime('11:00') ), date_i18n( 'H:i a', strtotime('12:00') ) ) //phpcs:ignore ?></el-option>
                                                <el-option label="<?php echo sprintf( esc_html__( '%1$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i', strtotime('11:00') ) ) //phpcs:ignore ?>" value="3" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php echo sprintf( esc_html__( '%1$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i', strtotime('11:00') ) ) //phpcs:ignore ?></el-option>
                                                <el-option label="<?php echo sprintf( esc_html__( '%1$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i a', strtotime('11:00') ) ) //phpcs:ignore ?>" value="4" :disabled="booking_form_settings.bookigpress_check_inherit_time_format == true"><?php echo sprintf( esc_html__( '%1$s', 'bookingpress-appointment-booking' ), date_i18n( 'H:i a', strtotime('11:00') ) ) //phpcs:ignore ?></el-option>
                                    ...
                                    <div class="bpa-cs-sp-sub-module--separator" v-if="is_staffmember_activated == '1'"></div>
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls" v-if="is_staffmember_activated == '1'">
                                        <div class="bpa-sm--item">
                                            <h5 class="bpa-sm-sub-heading--item"><?php esc_html_e( 'Staff Member Step Settings', 'bookingpress-appointment-booking'); ?></h5>
                                        </div>
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">
                                        ...
                                        <div class="bpa-sm--item">
                                            ...
                                            <el-radio v-model="booking_form_settings.redirection_mode" label="external_redirection"><?php esc_html_e('External Page', 'bookingpress-appointment-booking'); ?></el-radio>
                                        </div>	
                                        ...
                                        <div v-if="booking_form_settings.redirection_mode == 'in-built'" class="bpa-customize-redirection-mode__in-built">   
                                            <div class="bpa-sm--item" >
                                                <el-row type="flex" class="bpa-customize-lp-field">
                                                    <el-col class="bpa-customize-built-in-row--wrapper" :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                            ...
                            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">
                                        ...
                                        <div class="bpa-sm--item" v-show="booking_form_settings.bpa_enable_searchbox">
                                            <label class="bpa-form-label"><?php esc_html_e('Service Search Placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="booking_form_settings.book_appointemnt_service_search_text" class="bpa-form-control"></el-input>        
                                        </div>
                                        <div class="bpa-cs-sp-sub-module--separator" v-if="is_staffmember_activated == '1'"></div>
                                        <h5 class="bpa-sm-sub-heading--item" v-if="is_staffmember_activated == '1'"><?php esc_html_e('Staff step labels', 'bookingpress-appointment-booking'); ?></h5>
                                        ...
                                        <div class="bpa-sm--item" v-if="is_staffmember_activated == '1'" v-show="booking_form_settings.bpa_enable_searchbox">
                                            <label class="bpa-form-label"><?php esc_html_e('Staff Search Placeholder', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="booking_form_settings.book_appointemnt_staff_search_text" class="bpa-form-control"></el-input>
                                        </div>                                        
                                        <?php
                                        ...
                                        <div class="bpa-cs-sp-sub-module--separator"></div>
                                        <h5 class="bpa-sm-sub-heading--item"><?php esc_html_e('Date & Time labels', 'bookingpress-appointment-booking'); ?></h5>
                                        <div class="bpa-sm--item">
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Summary step title', 'bookingpress-appointment-booking'); ?></label>
                                        ...
                                        <div class="bpa-sm--item">
                                            ...
                                            <el-input class="bpa-form-control" v-model="summary_container_data.service_extras_label"> </el-input>
                                        </div>
                                        <div class="bpa-sm--item">
                                        ...
                                        <div class="bpa-cs-sp-sub-module--separator"></div>
                                        <h5 class="bpa-sm-sub-heading--item"><?php esc_html_e('Payment Link Labels', 'bookingpress-appointment-booking'); ?></h5>
                                        <div class="bpa-sm--item">
                        ...
                        <el-row type="flex">
                            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-sm--swtich">
                                        <div class="bpa-sm--item">                
                                            <h5 class="bpa-sm-sub-heading--item"><?php esc_html_e('Customer Options', 'bookingpress-appointment-booking'); ?></h5>
                                        </div>
                                        <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">
                                            <div class="bpa-sm--item --bpa-is-flexbox">
                                            ...
                                            <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls" v-show="my_booking_field_settings.allow_to_cancel_appointment">
                                                <div class="bpa-sm--item">
                                                    <label class="bpa-form-label" style="max-width:100%"><?php esc_html_e('Appointment cancellation confirmation', 'bookingpress-appointment-booking'); ?></label>
                                                ...
                                                <div class="bpa-sm--item">
                                                    <label class="bpa-form-label" style="max-width:100%"><?php esc_html_e('Cancelled appointment redirection', 'bookingpress-appointment-booking'); ?></label>
                                        ...
                                        <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">
                                            <div class="bpa-sm--item --bpa-is-flexbox">
                                                <label class="bpa-form-label"><?php esc_html_e( 'Allow reschedule appointment', 'bookingpress-appointment-booking' ); ?></label>
                                                <el-switch v-model="my_booking_field_settings.allow_customer_reschedule_apt" class="bpa-swtich-control"></el-switch>
                                            </div>
                                            <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls" v-show="my_booking_field_settings.allow_customer_reschedule_apt">
                                                <div class="bpa-sm--item">
                                                    <label class="bpa-form-label" style="max-width:100%"><?php esc_html_e('Appointment reschedule Page', 'bookingpress-appointment-booking'); ?></label>
                                        ...
                                        <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls" >
                                            <div class="bpa-sm--item --bpa-is-flexbox">
                                                <label class="bpa-form-label"><?php esc_html_e( 'Allow repeat booking', 'bookingpress-appointment-booking' ); ?></label>
                                                <el-switch v-model="my_booking_field_settings.allow_customer_book_again" class="bpa-swtich-control"></el-switch>
                                            </div>
                                            <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls" v-show="my_booking_field_settings.allow_customer_book_again">
                                                <div class="bpa-sm--item">
                                                    <label class="bpa-form-label" style="max-width:100%"><?php esc_html_e('Repeat Booking Page', 'bookingpress-appointment-booking'); ?></label>
                                                    <el-select v-model="my_booking_field_settings.book_again_page" class="bpa-form-control" filterable popper-class="bpa-el-select--is-with-navbar bpa-el-select--is-customize-left-panel">
                                                        <el-option v-for="item in bookingpress_all_global_pages" :key="item.post_title" :label="item.post_title"  :value="''+item.ID"></el-option>
                                                    </el-select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                            <label class="bpa-form-label"><?php esc_html_e( 'Allow edit profile', 'bookingpress-appointment-booking' ); ?></label>
                            ...
                            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-cs-sp--form-controls">       
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Book again title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.book_again_button_title" class="bpa-form-control"></el-input>
                                        </div>
                                        ...
                                        <div class="bpa-sm--item">
                                            <label class="bpa-form-label"><?php esc_html_e('Change password form title', 'bookingpress-appointment-booking'); ?></label>
                                            <el-input v-model="my_booking_field_settings.change_password_form_title" class="bpa-form-control"></el-input>
                                        </div>
                                        <div class="bpa-sm--item">
