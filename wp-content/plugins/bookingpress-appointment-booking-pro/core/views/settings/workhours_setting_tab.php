                    ...
                    <el-col :xs="24" :sm="24" :md="24" :lg="18" :xl="16" class="bpa-gs__cb-item-right">
                        <el-row :gutter="24">
                            <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="9">
                                <el-select v-model="workhours_timings[work_hours_day.day_name].start_time" class="bpa-form-control bpa-form-control__left-icon" placeholder="<?php esc_html_e('Start Time', 'bookingpress-appointment-booking'); ?>" popper-class="bpa-el-select--is-with-navbar" @change="bookingpress_set_workhour_value_pro($event,work_hours_day.day_name)" filterable>
                                    <span slot="prefix" class="material-icons-round">access_time</span>
                                    <el-option v-for="(work_timings, time_key) in worktimings[work_hours_day.day_name]" :label="work_timings.start_time_formatted" :value="work_timings.start_time_val" v-if="work_timings.start_time_val < '24:00:00' || work_timings.start_time_val == 'Off'"></el-option>
                                </el-select>
                            </el-col>
                            <el-col :xs="8" :sm="8" :md="8" :lg="8" :xl="9" v-if="workhours_timings[work_hours_day.day_name].start_time != 'Off'">
                                <el-select v-model="workhours_timings[work_hours_day.day_name].end_time" class="bpa-form-control bpa-form-control__left-icon" 
                                    ...
                                    <span slot="prefix" class="material-icons-round">access_time</span>
                                    <el-option v-for="(work_timings, time_key) in worktimings[work_hours_day.day_name]" :label="work_timings.end_time_formatted" :value="work_timings.end_time_val" v-if="(work_timings.end_time_val > workhours_timings[work_hours_day.day_name].start_time && true == work_timings.is_visible )"></el-option>
                                    <?php /* <el-option v-for="work_timings in work_hours_day.worktimes" :label="work_timings.formatted_end_time" :value="work_timings.end_time" v-if="( work_timings.end_time > workhours_timings[work_hours_day.day_name].start_time || work_timings.end_time == '24:00:00') "></el-option> */ ?>
                                </el-select>
                            </el-col>
                                    ...
                                    <el-col :xs="24" :sm="24" :md="12" :lg="12" :xl="12">
                                        <el-form-item prop="end_time">
                                            ...
                                            <el-select v-model="break_timings.end_time" class="bpa-form-control bpa-form-control__left-icon" filterable placeholder="<?php esc_html_e('End Time', 'bookingpress-appointment-booking'); ?>">
                                                <span slot="prefix" class="material-icons-round">access_time</span>
												<el-option v-for="break_times in default_break_timings" :key="break_times.end_time" :label="break_times.formatted_start_time" :value="break_times.start_time_val" v-if="(break_times.start_time_val > workhours_timings[break_selected_day].start_time && break_times.start_time_val < workhours_timings[break_selected_day].end_time) && (break_times.start_time_val > break_timings.start_time)"></el-option>
                                            </el-select>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
