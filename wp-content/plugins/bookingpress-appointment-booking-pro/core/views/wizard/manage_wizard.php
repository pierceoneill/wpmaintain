							...
							<el-row type="flex" align="middle" :gutter="32">
								...
								<el-col :xs="08" :sm="08" :md="08" :lg="08" :xl="08" v-if="wizard_steps_data.booking_options.monday.start_time != 'off'">
									<el-select filterable v-model="wizard_steps_data.booking_options.monday.end_time" class="bpa-form-control" @change="bookingpress_check_workhour_value_wizard($event,'monday')">
										<el-option v-for="workhours_arr in working_hours_arr" :label="workhours_arr.formatted_end_time" :value="workhours_arr.end_time" v-if="( workhours_arr.end_time > wizard_steps_data.booking_options.monday.start_time || workhours_arr.end_time == '24:00:00')"></el-option>
								</el-col>
							</el-row>
							<el-row type="flex" align="middle" :gutter="32">
								<el-col :xs="08" :sm="08" :md="08" :lg="08" :xl="08">
								...
								<el-col :xs="08" :sm="08" :md="08" :lg="08" :xl="08" v-if="wizard_steps_data.booking_options.tuesday.start_time != 'off'">
									<el-select filterable v-model="wizard_steps_data.booking_options.tuesday.end_time" class="bpa-form-control" @change="bookingpress_check_workhour_value_wizard($event,'tuesday')">
										<el-option v-for="workhours_arr in working_hours_arr" :label="workhours_arr.formatted_end_time" :value="workhours_arr.end_time" v-if="( workhours_arr.end_time > wizard_steps_data.booking_options.tuesday.start_time || workhours_arr.end_time == '24:00:00')"></el-option>
									</el-select>
								</el-col>
							</el-row>
							<el-row type="flex" align="middle" :gutter="32">
								...
								<el-col :xs="08" :sm="08" :md="08" :lg="08" :xl="08" v-if="wizard_steps_data.booking_options.wednesday.start_time != 'off'">
									<el-select filterable v-model="wizard_steps_data.booking_options.wednesday.end_time" class="bpa-form-control" @change="bookingpress_check_workhour_value_wizard($event,'wednesday')">
										<el-option v-for="workhours_arr in working_hours_arr" :label="workhours_arr.formatted_end_time" :value="workhours_arr.end_time" v-if="( workhours_arr.end_time > wizard_steps_data.booking_options.wednesday.start_time || workhours_arr.end_time == '24:00:00')"></el-option>
									</el-select>
								</el-col>
							</el-row>
							<el-row type="flex" align="middle" :gutter="32">
								...
								<el-col :xs="08" :sm="08" :md="08" :lg="08" :xl="08" v-if="wizard_steps_data.booking_options.thursday.start_time != 'off'">
									<el-select filterable v-model="wizard_steps_data.booking_options.thursday.end_time" class="bpa-form-control" @change="bookingpress_check_workhour_value_wizard($event,'thursday')">
										<el-option v-for="workhours_arr in working_hours_arr" :label="workhours_arr.formatted_end_time" :value="workhours_arr.end_time" v-if="( workhours_arr.end_time > wizard_steps_data.booking_options.thursday.start_time || workhours_arr.end_time == '24:00:00')"></el-option>
									</el-select>
								</el-col>
							</el-row>
							<el-row type="flex" align="middle" :gutter="32">
								...
								<el-col :xs="08" :sm="08" :md="08" :lg="08" :xl="08" v-if="wizard_steps_data.booking_options.friday.start_time != 'off'">
									<el-select filterable v-model="wizard_steps_data.booking_options.friday.end_time" class="bpa-form-control" @change="bookingpress_check_workhour_value_wizard($event,'friday')">
										<el-option v-for="workhours_arr in working_hours_arr" :label="workhours_arr.formatted_end_time" :value="workhours_arr.end_time" v-if="( workhours_arr.end_time > wizard_steps_data.booking_options.friday.start_time || workhours_arr.end_time == '24:00:00')"></el-option>
									</el-select>
								</el-col>
							</el-row>
							<el-row type="flex" align="middle" :gutter="32">
								...
								<el-col :xs="08" :sm="08" :md="08" :lg="08" :xl="08" v-if="wizard_steps_data.booking_options.saturday.start_time != 'off'">					<el-select filterable v-model="wizard_steps_data.booking_options.saturday.end_time" class="bpa-form-control" @change="bookingpress_check_workhour_value_wizard($event,'saturday')">
										<el-option v-for="workhours_arr in working_hours_arr" :label="workhours_arr.formatted_end_time" :value="workhours_arr.end_time" v-if="( workhours_arr.end_time > wizard_steps_data.booking_options.saturday.start_time || workhours_arr.end_time == '24:00:00')"></el-option>
									</el-select>
								</el-col>
							</el-row>
							<el-row type="flex" align="middle" :gutter="32">
								...
								<el-col :xs="08" :sm="08" :md="08" :lg="08" :xl="08" v-if="wizard_steps_data.booking_options.sunday.start_time != 'off'">
									<el-select filterable v-model="wizard_steps_data.booking_options.sunday.end_time" class="bpa-form-control" @change="bookingpress_check_workhour_value_wizard($event,'sunday')">
										<el-option v-for="workhours_arr in working_hours_arr" :label="workhours_arr.formatted_end_time" :value="workhours_arr.end_time" v-if="( workhours_arr.end_time > wizard_steps_data.booking_options.sunday.start_time || workhours_arr.end_time == '24:00:00')"></el-option>
									</el-select>
								</el-col>
							</el-row>
						</div>
