...
if ( ! class_exists( 'bookingpress_pro_dashboard' ) ) {
	class bookingpress_pro_dashboard Extends BookingPress_Core {
		...
		function bookingpress_modify_dashboard_data_fields_func( $bookingpress_dashboard_vue_data_fields ) {
			...
			$bookingpress_dashboard_vue_data_fields['rules']['appointment_booked_end_time'] = array(
				array(
					'required' => true,
			...
			$bookingpress_dashboard_vue_data_fields['deposit_payment_module'] = $deposit_payment_module;			
			...
			$bookingpress_dashboard_vue_data_fields['bookingpress_deposit_payment_method'] = $bookingpress_deposit_payment_method;
			$bookingpress_dashboard_vue_data_fields['appointment_formdata']['bookingpress_deposit_payment_method'] = $bookingpress_deposit_payment_method;
			$bookingpress_dashboard_vue_data_fields['appointment_formdata']['bookingpress_applied_deposit'] = "0";
			/* Deposit Add Appointment Data Over Here */

			$bookingpress_dashboard_vue_data_fields['appointment_formdata']['appointment_booked_end_date'] = '';			
			$bookingpress_dashboard_vue_data_fields['appointment_formdata']['appointment_custom_timing'] = false;

            $default_appointment_timing = $BookingPressPro->bookingpress_get_default_appointment_timing();
            $bookingpress_dashboard_vue_data_fields['appointment_formdata']['default_appointment_timing'] = $default_appointment_timing;							
