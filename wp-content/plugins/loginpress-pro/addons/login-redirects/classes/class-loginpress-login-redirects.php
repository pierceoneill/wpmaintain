...
if ( ! class_exists( 'LoginPress_Login_Redirect_Main' ) ) :
	...
	class LoginPress_Login_Redirect_Main {
		...
		public function login_redirect_script_html() {
			...
			$html = '<div class="row-per-page"><span style="margin-right: 8px;">' . __( 'Show Entries', 'loginpress-pro' ) . '</span> <select id="loginpress_login_redirect_users_select" class="selectbox" style="width: 100px; height: 45px; padding: 2px;"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select></div><table id="loginpress_login_redirect_users" class="loginpress_login_redirect_users">
			<thead><tr>
