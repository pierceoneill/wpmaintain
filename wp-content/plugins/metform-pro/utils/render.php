        ...
        <li>
            <a href="#<?php echo esc_html($id); ?>" class="mf-setting-nav-link">
                <div class="mf-setting-tab-content">
                    <span class="mf-setting-title"><?php echo esc_html__($lable, 'metform-pro'); ?></span>
                    <span class="mf-setting-subtitle"><?php echo esc_html__($caption, 'metform-pro'); ?></span>
                </div>
            </a>
        </li>
        ...
        <div class="mf-settings-section" id="<?php echo esc_html($id); ?>">
            <div class="mf-settings-single-section">
                <div class="mf-setting-header">
                    <h3 class="mf-settings-single-section--title"><?php esc_html_e($title, 'metform-pro'); ?></h3>
                    <button type="submit" name="submit" id="submit" class="button button-primary"><span
                                class="mf-admin-save-icon dashicons dashicons-yes-alt"></span><?php esc_attr_e('Save Changes', 'metform-pro'); ?>
                    </button>
                </div>
    ...
    public static function sub_tab($title, $target_id, $is_active = null)
    {
        ...
        <li class="attr-<?php echo esc_html($is_active); ?> attr-in">
            <a class="attr-nav-item attr-nav-link" data-toggle="tab" href="#<?php echo esc_html($target_id); ?> "
               role="tab"><?php esc_attr_e($title, 'metform-pro'); ?></a>
        </li>
    ...
    public static function textbox($data)
    {
        ...
        <div class="mf-setting-input-group">
            <label for="attr-input-label"
                   class="mf-setting-label mf-setting-label attr-input-label"><?php esc_html_e($data['lable'], 'metform-pro'); ?></label>
            <input type="text" name="<?php echo esc_attr($data['name']); ?>"
                   ...
                   placeholder="<?php esc_html_e($data['placeholder'], 'metform-pro'); ?>">
            <p class="description">
                <?php esc_html_e($data['description'], 'metform-pro'); ?>
            </p>
        </div>
    ...
    public static function checkbox($data)
    {
        ...
        <div class="mf-input-group">
            <label class="attr-input-label">
                <input type="checkbox"
                       value="1"
                       name="<?php echo esc_html_e($data['name'], 'metform-pro'); ?>"
                       class="mf-admin-control-input <?php echo esc_html_e($data['class'], 'metform-pro'); ?>">


                <span>
                        <?php esc_html_e($data['label'], 'metform-pro'); ?>
                    </span>
            ...
            <?php if (isset($data['details'])): ?>
                <span
                        class='mf-input-help'>
                    <?php esc_html_e($data['details'], 'metform-pro'); ?>
    ...
    public static function form_tab($id, $lable)
    {
        ...
        <li role="presentation">
            <a href="#<?php echo $id; ?>" aria-controls="crm" role="tab" data-toggle="tab">
                <?php esc_html_e($lable, 'metform-pro'); ?>
            </a>
        </li>
