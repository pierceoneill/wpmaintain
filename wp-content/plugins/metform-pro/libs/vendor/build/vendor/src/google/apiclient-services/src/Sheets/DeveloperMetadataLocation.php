...
class DeveloperMetadataLocation extends \MetFormProVendor\Google\Model
{
...
\class_alias(DeveloperMetadataLocation::class, 'MetFormProVendor\\Google_Service_Sheets_DeveloperMetadataLocation');
