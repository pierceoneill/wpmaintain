...
class ManualRuleGroup extends \MetFormProVendor\Google\Collection
{
...
\class_alias(ManualRuleGroup::class, 'MetFormProVendor\\Google_Service_Sheets_ManualRuleGroup');
