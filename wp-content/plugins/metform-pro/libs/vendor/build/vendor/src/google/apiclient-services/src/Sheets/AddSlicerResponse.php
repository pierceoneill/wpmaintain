...
class AddSlicerResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(AddSlicerResponse::class, 'MetFormProVendor\\Google_Service_Sheets_AddSlicerResponse');
