...
class WaterfallChartSeries extends \MetFormProVendor\Google\Collection
{
...
\class_alias(WaterfallChartSeries::class, 'MetFormProVendor\\Google_Service_Sheets_WaterfallChartSeries');
