...
class BatchClearValuesByDataFilterResponse extends \MetFormProVendor\Google\Collection
{
...
\class_alias(BatchClearValuesByDataFilterResponse::class, 'MetFormProVendor\\Google_Service_Sheets_BatchClearValuesByDataFilterResponse');
