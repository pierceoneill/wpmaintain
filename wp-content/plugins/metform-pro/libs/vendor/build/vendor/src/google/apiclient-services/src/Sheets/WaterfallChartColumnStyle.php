...
class WaterfallChartColumnStyle extends \MetFormProVendor\Google\Model
{
...
\class_alias(WaterfallChartColumnStyle::class, 'MetFormProVendor\\Google_Service_Sheets_WaterfallChartColumnStyle');
