...
class UpdateBordersRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(UpdateBordersRequest::class, 'MetFormProVendor\\Google_Service_Sheets_UpdateBordersRequest');
