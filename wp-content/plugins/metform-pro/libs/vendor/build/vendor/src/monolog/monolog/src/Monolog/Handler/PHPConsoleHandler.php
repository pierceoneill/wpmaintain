...
use MetFormProVendor\Monolog\Formatter\LineFormatter;
use MetFormProVendor\Monolog\Formatter\FormatterInterface;
use MetFormProVendor\Monolog\Logger;
use MetFormProVendor\Monolog\Utils;
use MetFormProVendor\PhpConsole\Connector;
use MetFormProVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use MetFormProVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('MetFormProVendor\\PhpConsole\\Connector')) {
