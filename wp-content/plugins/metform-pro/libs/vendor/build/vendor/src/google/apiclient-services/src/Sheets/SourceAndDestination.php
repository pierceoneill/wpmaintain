...
class SourceAndDestination extends \MetFormProVendor\Google\Model
{
    public $dimension;
    public $fillLength;
...
\class_alias(SourceAndDestination::class, 'MetFormProVendor\\Google_Service_Sheets_SourceAndDestination');
