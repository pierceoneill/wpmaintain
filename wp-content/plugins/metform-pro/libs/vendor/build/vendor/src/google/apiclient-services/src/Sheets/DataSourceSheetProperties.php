...
class DataSourceSheetProperties extends \MetFormProVendor\Google\Collection
{
...
\class_alias(DataSourceSheetProperties::class, 'MetFormProVendor\\Google_Service_Sheets_DataSourceSheetProperties');
