...
class PivotGroupSortValueBucket extends \MetFormProVendor\Google\Collection
{
...
\class_alias(PivotGroupSortValueBucket::class, 'MetFormProVendor\\Google_Service_Sheets_PivotGroupSortValueBucket');
