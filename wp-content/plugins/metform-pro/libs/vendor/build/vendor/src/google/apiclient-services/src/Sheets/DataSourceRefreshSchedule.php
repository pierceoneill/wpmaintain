...
class DataSourceRefreshSchedule extends \MetFormProVendor\Google\Model
{
...
\class_alias(DataSourceRefreshSchedule::class, 'MetFormProVendor\\Google_Service_Sheets_DataSourceRefreshSchedule');
