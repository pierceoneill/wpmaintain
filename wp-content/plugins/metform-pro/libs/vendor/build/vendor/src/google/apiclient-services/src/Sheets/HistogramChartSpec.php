...
class HistogramChartSpec extends \MetFormProVendor\Google\Collection
{
...
\class_alias(HistogramChartSpec::class, 'MetFormProVendor\\Google_Service_Sheets_HistogramChartSpec');
