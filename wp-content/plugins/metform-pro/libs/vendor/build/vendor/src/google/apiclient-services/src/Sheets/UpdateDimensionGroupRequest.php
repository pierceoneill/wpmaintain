...
class UpdateDimensionGroupRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(UpdateDimensionGroupRequest::class, 'MetFormProVendor\\Google_Service_Sheets_UpdateDimensionGroupRequest');
