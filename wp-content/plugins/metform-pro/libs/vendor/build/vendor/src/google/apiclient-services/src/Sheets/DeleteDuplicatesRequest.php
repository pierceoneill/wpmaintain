...
class DeleteDuplicatesRequest extends \MetFormProVendor\Google\Collection
{
...
\class_alias(DeleteDuplicatesRequest::class, 'MetFormProVendor\\Google_Service_Sheets_DeleteDuplicatesRequest');
