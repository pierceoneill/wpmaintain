...
class BasicChartSeries extends \MetFormProVendor\Google\Collection
{
...
\class_alias(BasicChartSeries::class, 'MetFormProVendor\\Google_Service_Sheets_BasicChartSeries');
