...
class UpdateCellsRequest extends \MetFormProVendor\Google\Collection
{
...
\class_alias(UpdateCellsRequest::class, 'MetFormProVendor\\Google_Service_Sheets_UpdateCellsRequest');
