...
class AutoResizeDimensionsRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(AutoResizeDimensionsRequest::class, 'MetFormProVendor\\Google_Service_Sheets_AutoResizeDimensionsRequest');
