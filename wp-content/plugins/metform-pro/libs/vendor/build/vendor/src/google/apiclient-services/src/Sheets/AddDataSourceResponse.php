...
class AddDataSourceResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(AddDataSourceResponse::class, 'MetFormProVendor\\Google_Service_Sheets_AddDataSourceResponse');
