...
class TextToColumnsRequest extends \MetFormProVendor\Google\Model
{
    public $delimiter;
...
\class_alias(TextToColumnsRequest::class, 'MetFormProVendor\\Google_Service_Sheets_TextToColumnsRequest');
