...
class FindReplaceResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(FindReplaceResponse::class, 'MetFormProVendor\\Google_Service_Sheets_FindReplaceResponse');
