...
class DataSourceColumn extends \MetFormProVendor\Google\Model
{
    public $formula;
...
\class_alias(DataSourceColumn::class, 'MetFormProVendor\\Google_Service_Sheets_DataSourceColumn');
