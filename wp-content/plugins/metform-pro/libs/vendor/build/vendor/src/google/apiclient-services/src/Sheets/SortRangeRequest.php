...
class SortRangeRequest extends \MetFormProVendor\Google\Collection
{
...
\class_alias(SortRangeRequest::class, 'MetFormProVendor\\Google_Service_Sheets_SortRangeRequest');
