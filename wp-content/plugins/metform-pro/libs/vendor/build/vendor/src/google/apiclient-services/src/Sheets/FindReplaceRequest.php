...
class FindReplaceRequest extends \MetFormProVendor\Google\Model
{
    public $allSheets;
    public $find;
...
\class_alias(FindReplaceRequest::class, 'MetFormProVendor\\Google_Service_Sheets_FindReplaceRequest');
