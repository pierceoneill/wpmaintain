...
class DataSourceTable extends \MetFormProVendor\Google\Collection
{
...
\class_alias(DataSourceTable::class, 'MetFormProVendor\\Google_Service_Sheets_DataSourceTable');
