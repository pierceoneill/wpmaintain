...
class UpdateNamedRangeRequest extends \MetFormProVendor\Google\Model
{
    public $fields;
...
\class_alias(UpdateNamedRangeRequest::class, 'MetFormProVendor\\Google_Service_Sheets_UpdateNamedRangeRequest');
