...
class DeleteBandingRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(DeleteBandingRequest::class, 'MetFormProVendor\\Google_Service_Sheets_DeleteBandingRequest');
