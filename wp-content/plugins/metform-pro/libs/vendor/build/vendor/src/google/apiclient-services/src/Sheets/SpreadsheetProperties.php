...
class SpreadsheetProperties extends \MetFormProVendor\Google\Model
{
    public $autoRecalc;
...
\class_alias(SpreadsheetProperties::class, 'MetFormProVendor\\Google_Service_Sheets_SpreadsheetProperties');
