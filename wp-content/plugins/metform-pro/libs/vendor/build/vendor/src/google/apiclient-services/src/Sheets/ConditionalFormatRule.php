...
class ConditionalFormatRule extends \MetFormProVendor\Google\Collection
{
...
\class_alias(ConditionalFormatRule::class, 'MetFormProVendor\\Google_Service_Sheets_ConditionalFormatRule');
