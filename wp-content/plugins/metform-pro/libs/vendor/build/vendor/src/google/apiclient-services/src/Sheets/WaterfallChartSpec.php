...
class WaterfallChartSpec extends \MetFormProVendor\Google\Collection
{
...
\class_alias(WaterfallChartSpec::class, 'MetFormProVendor\\Google_Service_Sheets_WaterfallChartSpec');
