...
class DuplicateSheetRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(DuplicateSheetRequest::class, 'MetFormProVendor\\Google_Service_Sheets_DuplicateSheetRequest');
