...
class EmbeddedObjectPosition extends \MetFormProVendor\Google\Model
{
    public $newSheet;
...
\class_alias(EmbeddedObjectPosition::class, 'MetFormProVendor\\Google_Service_Sheets_EmbeddedObjectPosition');
