...
class InsertDimensionRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(InsertDimensionRequest::class, 'MetFormProVendor\\Google_Service_Sheets_InsertDimensionRequest');
