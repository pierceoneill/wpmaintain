...
class PivotFilterCriteria extends \MetFormProVendor\Google\Collection
{
...
\class_alias(PivotFilterCriteria::class, 'MetFormProVendor\\Google_Service_Sheets_PivotFilterCriteria');
