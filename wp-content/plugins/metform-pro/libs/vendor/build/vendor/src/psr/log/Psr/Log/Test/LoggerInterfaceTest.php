...
namespace MetFormProVendor\Psr\Log\Test;

use MetFormProVendor\Psr\Log\LoggerInterface;
use MetFormProVendor\Psr\Log\LogLevel;
use MetFormProVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('MetFormProVendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('MetFormProVendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('MetFormProVendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
