...
class DeleteDimensionGroupResponse extends \MetFormProVendor\Google\Collection
{
...
\class_alias(DeleteDimensionGroupResponse::class, 'MetFormProVendor\\Google_Service_Sheets_DeleteDimensionGroupResponse');
