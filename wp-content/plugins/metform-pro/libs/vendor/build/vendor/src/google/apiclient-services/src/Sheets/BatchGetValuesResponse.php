...
class BatchGetValuesResponse extends \MetFormProVendor\Google\Collection
{
...
\class_alias(BatchGetValuesResponse::class, 'MetFormProVendor\\Google_Service_Sheets_BatchGetValuesResponse');
