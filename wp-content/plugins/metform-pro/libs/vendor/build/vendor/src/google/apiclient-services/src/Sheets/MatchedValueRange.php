...
class MatchedValueRange extends \MetFormProVendor\Google\Collection
{
...
\class_alias(MatchedValueRange::class, 'MetFormProVendor\\Google_Service_Sheets_MatchedValueRange');
