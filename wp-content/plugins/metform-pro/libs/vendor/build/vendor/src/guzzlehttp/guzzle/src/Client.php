...
use MetFormProVendor\GuzzleHttp\Cookie\CookieJar;
use MetFormProVendor\GuzzleHttp\Exception\GuzzleException;
use MetFormProVendor\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \MetFormProVendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
