...
class ScorecardChartSpec extends \MetFormProVendor\Google\Model
{
...
\class_alias(ScorecardChartSpec::class, 'MetFormProVendor\\Google_Service_Sheets_ScorecardChartSpec');
