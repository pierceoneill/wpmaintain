...
class DeleteDuplicatesResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(DeleteDuplicatesResponse::class, 'MetFormProVendor\\Google_Service_Sheets_DeleteDuplicatesResponse');
