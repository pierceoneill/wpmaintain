...
class AddNamedRangeRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(AddNamedRangeRequest::class, 'MetFormProVendor\\Google_Service_Sheets_AddNamedRangeRequest');
