...
use MetFormProVendor\Aws\Sdk;
use MetFormProVendor\Aws\DynamoDb\DynamoDbClient;
use MetFormProVendor\Monolog\Formatter\FormatterInterface;
use MetFormProVendor\Aws\DynamoDb\Marshaler;
use MetFormProVendor\Monolog\Formatter\ScalarFormatter;
