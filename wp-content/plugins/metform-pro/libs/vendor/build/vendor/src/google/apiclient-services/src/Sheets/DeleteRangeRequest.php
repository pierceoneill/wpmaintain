...
class DeleteRangeRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(DeleteRangeRequest::class, 'MetFormProVendor\\Google_Service_Sheets_DeleteRangeRequest');
