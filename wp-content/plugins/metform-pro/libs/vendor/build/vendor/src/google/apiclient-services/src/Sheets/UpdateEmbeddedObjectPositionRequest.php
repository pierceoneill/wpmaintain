...
class UpdateEmbeddedObjectPositionRequest extends \MetFormProVendor\Google\Model
{
    public $fields;
...
\class_alias(UpdateEmbeddedObjectPositionRequest::class, 'MetFormProVendor\\Google_Service_Sheets_UpdateEmbeddedObjectPositionRequest');
