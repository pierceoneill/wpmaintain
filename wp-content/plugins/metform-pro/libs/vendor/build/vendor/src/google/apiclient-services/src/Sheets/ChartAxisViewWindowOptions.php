...
class ChartAxisViewWindowOptions extends \MetFormProVendor\Google\Model
{
...
\class_alias(ChartAxisViewWindowOptions::class, 'MetFormProVendor\\Google_Service_Sheets_ChartAxisViewWindowOptions');
