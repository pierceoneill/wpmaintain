...
class AddSlicerRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(AddSlicerRequest::class, 'MetFormProVendor\\Google_Service_Sheets_AddSlicerRequest');
