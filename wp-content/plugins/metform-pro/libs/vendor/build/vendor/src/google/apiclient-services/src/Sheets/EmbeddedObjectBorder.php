...
class EmbeddedObjectBorder extends \MetFormProVendor\Google\Model
{
...
\class_alias(EmbeddedObjectBorder::class, 'MetFormProVendor\\Google_Service_Sheets_EmbeddedObjectBorder');
