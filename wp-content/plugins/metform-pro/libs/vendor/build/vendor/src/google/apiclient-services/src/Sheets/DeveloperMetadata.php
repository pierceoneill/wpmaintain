...
class DeveloperMetadata extends \MetFormProVendor\Google\Model
{
...
\class_alias(DeveloperMetadata::class, 'MetFormProVendor\\Google_Service_Sheets_DeveloperMetadata');
