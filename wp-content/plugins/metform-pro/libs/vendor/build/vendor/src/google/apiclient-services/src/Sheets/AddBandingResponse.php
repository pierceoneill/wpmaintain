...
class AddBandingResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(AddBandingResponse::class, 'MetFormProVendor\\Google_Service_Sheets_AddBandingResponse');
