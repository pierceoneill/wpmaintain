 ...
 */
namespace MetFormProVendor\Google;

use MetFormProVendor\Google\AccessToken\Revoke;
use MetFormProVendor\Google\AccessToken\Verify;
use MetFormProVendor\Google\Auth\ApplicationDefaultCredentials;
use MetFormProVendor\Google\Auth\Cache\MemoryCacheItemPool;
use MetFormProVendor\Google\Auth\CredentialsLoader;
use MetFormProVendor\Google\Auth\FetchAuthTokenCache;
use MetFormProVendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use MetFormProVendor\Google\Auth\OAuth2;
...
use MetFormProVendor\Google\AuthHandler\AuthHandlerFactory;
use MetFormProVendor\Google\Http\REST;
use MetFormProVendor\GuzzleHttp\Client as GuzzleClient;
use MetFormProVendor\GuzzleHttp\ClientInterface;
use MetFormProVendor\GuzzleHttp\Ring\Client\StreamHandler;
use MetFormProVendor\Psr\Cache\CacheItemPoolInterface;
use MetFormProVendor\Psr\Http\Message\RequestInterface;
use MetFormProVendor\Psr\Log\LoggerInterface;
use MetFormProVendor\Monolog\Logger;
use MetFormProVendor\Monolog\Handler\StreamHandler as MonologStreamHandler;
use MetFormProVendor\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
...
class Client
{
    ...
    protected function createDefaultHttpClient()
    {
        ...
        } elseif (\defined('\\MetFormProVendor\\GuzzleHttp\\ClientInterface::VERSION')) {
