...
class AddChartResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(AddChartResponse::class, 'MetFormProVendor\\Google_Service_Sheets_AddChartResponse');
