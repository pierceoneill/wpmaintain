...
class ClearValuesResponse extends \MetFormProVendor\Google\Model
{
    public $clearedRange;
...
\class_alias(ClearValuesResponse::class, 'MetFormProVendor\\Google_Service_Sheets_ClearValuesResponse');
