...
class BatchClearValuesResponse extends \MetFormProVendor\Google\Collection
{
...
\class_alias(BatchClearValuesResponse::class, 'MetFormProVendor\\Google_Service_Sheets_BatchClearValuesResponse');
