...
class UpdateBandingRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(UpdateBandingRequest::class, 'MetFormProVendor\\Google_Service_Sheets_UpdateBandingRequest');
