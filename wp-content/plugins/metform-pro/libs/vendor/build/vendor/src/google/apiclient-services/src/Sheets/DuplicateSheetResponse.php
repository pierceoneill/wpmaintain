...
class DuplicateSheetResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(DuplicateSheetResponse::class, 'MetFormProVendor\\Google_Service_Sheets_DuplicateSheetResponse');
