...
class GetSpreadsheetByDataFilterRequest extends \MetFormProVendor\Google\Collection
{
...
\class_alias(GetSpreadsheetByDataFilterRequest::class, 'MetFormProVendor\\Google_Service_Sheets_GetSpreadsheetByDataFilterRequest');
