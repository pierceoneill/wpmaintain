...
use MetFormProVendor\Swift_Message;
use MetFormProVendor\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\MetFormProVendor\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
