...
class DataSourceChartProperties extends \MetFormProVendor\Google\Model
{
...
\class_alias(DataSourceChartProperties::class, 'MetFormProVendor\\Google_Service_Sheets_DataSourceChartProperties');
