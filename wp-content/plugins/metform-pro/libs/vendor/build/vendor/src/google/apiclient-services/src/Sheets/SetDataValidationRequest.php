...
class SetDataValidationRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(SetDataValidationRequest::class, 'MetFormProVendor\\Google_Service_Sheets_SetDataValidationRequest');
