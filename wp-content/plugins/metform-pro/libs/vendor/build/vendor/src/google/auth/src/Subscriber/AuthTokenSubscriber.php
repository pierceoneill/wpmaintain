 ...
 */
namespace MetFormProVendor\Google\Auth\Subscriber;

use MetFormProVendor\Google\Auth\FetchAuthTokenInterface;
use MetFormProVendor\Google\Auth\GetQuotaProjectInterface;
use MetFormProVendor\GuzzleHttp\Event\BeforeEvent;
use MetFormProVendor\GuzzleHttp\Event\RequestEvents;
use MetFormProVendor\GuzzleHttp\Event\SubscriberInterface;
/**
