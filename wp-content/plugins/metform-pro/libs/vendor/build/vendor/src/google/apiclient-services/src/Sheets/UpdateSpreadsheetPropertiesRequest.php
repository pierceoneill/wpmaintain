...
class UpdateSpreadsheetPropertiesRequest extends \MetFormProVendor\Google\Model
{
    public $fields;
...
\class_alias(UpdateSpreadsheetPropertiesRequest::class, 'MetFormProVendor\\Google_Service_Sheets_UpdateSpreadsheetPropertiesRequest');
