...
class UpdateValuesByDataFilterResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(UpdateValuesByDataFilterResponse::class, 'MetFormProVendor\\Google_Service_Sheets_UpdateValuesByDataFilterResponse');
