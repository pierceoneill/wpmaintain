...
class AddNamedRangeResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(AddNamedRangeResponse::class, 'MetFormProVendor\\Google_Service_Sheets_AddNamedRangeResponse');
