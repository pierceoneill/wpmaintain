 ...
 */
namespace MetFormProVendor\Composer;

use MetFormProVendor\Composer\Autoload\ClassLoader;
use MetFormProVendor\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('MetFormProVendor\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
