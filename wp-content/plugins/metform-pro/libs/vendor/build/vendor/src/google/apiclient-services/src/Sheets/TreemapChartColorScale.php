...
class TreemapChartColorScale extends \MetFormProVendor\Google\Model
{
...
\class_alias(TreemapChartColorScale::class, 'MetFormProVendor\\Google_Service_Sheets_TreemapChartColorScale');
