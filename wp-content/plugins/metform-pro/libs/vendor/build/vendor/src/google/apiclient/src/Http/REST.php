 ...
 */
namespace MetFormProVendor\Google\Http;

use MetFormProVendor\Google\Auth\HttpHandler\HttpHandlerFactory;
use MetFormProVendor\Google\Client;
use MetFormProVendor\Google\Task\Runner;
use MetFormProVendor\Google\Service\Exception as GoogleServiceException;
use MetFormProVendor\GuzzleHttp\ClientInterface;
use MetFormProVendor\GuzzleHttp\Exception\RequestException;
use MetFormProVendor\GuzzleHttp\Psr7\Response;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if ($response instanceof \MetFormProVendor\GuzzleHttp\Message\ResponseInterface) {
