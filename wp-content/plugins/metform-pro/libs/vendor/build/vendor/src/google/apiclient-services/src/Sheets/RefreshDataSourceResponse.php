...
class RefreshDataSourceResponse extends \MetFormProVendor\Google\Collection
{
...
\class_alias(RefreshDataSourceResponse::class, 'MetFormProVendor\\Google_Service_Sheets_RefreshDataSourceResponse');
