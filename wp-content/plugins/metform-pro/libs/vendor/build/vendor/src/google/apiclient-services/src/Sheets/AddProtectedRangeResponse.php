...
class AddProtectedRangeResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(AddProtectedRangeResponse::class, 'MetFormProVendor\\Google_Service_Sheets_AddProtectedRangeResponse');
