...
class CandlestickChartSpec extends \MetFormProVendor\Google\Collection
{
...
\class_alias(CandlestickChartSpec::class, 'MetFormProVendor\\Google_Service_Sheets_CandlestickChartSpec');
