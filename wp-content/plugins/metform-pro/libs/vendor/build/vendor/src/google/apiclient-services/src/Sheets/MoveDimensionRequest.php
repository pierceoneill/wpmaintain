...
class MoveDimensionRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(MoveDimensionRequest::class, 'MetFormProVendor\\Google_Service_Sheets_MoveDimensionRequest');
