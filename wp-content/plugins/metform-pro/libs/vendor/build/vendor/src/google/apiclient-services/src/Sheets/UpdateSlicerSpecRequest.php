...
class UpdateSlicerSpecRequest extends \MetFormProVendor\Google\Model
{
    public $fields;
    public $slicerId;
...
\class_alias(UpdateSlicerSpecRequest::class, 'MetFormProVendor\\Google_Service_Sheets_UpdateSlicerSpecRequest');
