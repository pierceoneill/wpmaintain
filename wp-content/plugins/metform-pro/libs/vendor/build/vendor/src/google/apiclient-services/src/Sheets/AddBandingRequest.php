...
class AddBandingRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(AddBandingRequest::class, 'MetFormProVendor\\Google_Service_Sheets_AddBandingRequest');
