...
class TrimWhitespaceResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(TrimWhitespaceResponse::class, 'MetFormProVendor\\Google_Service_Sheets_TrimWhitespaceResponse');
