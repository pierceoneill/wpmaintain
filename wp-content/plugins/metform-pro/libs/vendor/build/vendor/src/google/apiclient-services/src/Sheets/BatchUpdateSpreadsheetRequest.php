...
class BatchUpdateSpreadsheetRequest extends \MetFormProVendor\Google\Collection
{
...
\class_alias(BatchUpdateSpreadsheetRequest::class, 'MetFormProVendor\\Google_Service_Sheets_BatchUpdateSpreadsheetRequest');
