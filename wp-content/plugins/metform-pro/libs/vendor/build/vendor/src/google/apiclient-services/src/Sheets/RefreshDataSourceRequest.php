...
class RefreshDataSourceRequest extends \MetFormProVendor\Google\Model
{
    public $dataSourceId;
    public $force;
    public $isAll;
...
\class_alias(RefreshDataSourceRequest::class, 'MetFormProVendor\\Google_Service_Sheets_RefreshDataSourceRequest');
