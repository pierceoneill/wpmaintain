...
class WaterfallChartCustomSubtotal extends \MetFormProVendor\Google\Model
{
...
\class_alias(WaterfallChartCustomSubtotal::class, 'MetFormProVendor\\Google_Service_Sheets_WaterfallChartCustomSubtotal');
