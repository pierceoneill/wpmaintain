...
class AddSheetResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(AddSheetResponse::class, 'MetFormProVendor\\Google_Service_Sheets_AddSheetResponse');
