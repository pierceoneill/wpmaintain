...
class BatchUpdateValuesRequest extends \MetFormProVendor\Google\Collection
{
...
\class_alias(BatchUpdateValuesRequest::class, 'MetFormProVendor\\Google_Service_Sheets_BatchUpdateValuesRequest');
