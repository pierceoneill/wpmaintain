...
class BatchUpdateValuesResponse extends \MetFormProVendor\Google\Collection
{
...
\class_alias(BatchUpdateValuesResponse::class, 'MetFormProVendor\\Google_Service_Sheets_BatchUpdateValuesResponse');
