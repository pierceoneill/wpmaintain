...
class AddDimensionGroupResponse extends \MetFormProVendor\Google\Collection
{
...
\class_alias(AddDimensionGroupResponse::class, 'MetFormProVendor\\Google_Service_Sheets_AddDimensionGroupResponse');
