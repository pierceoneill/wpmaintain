...
class UpdateDataSourceResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(UpdateDataSourceResponse::class, 'MetFormProVendor\\Google_Service_Sheets_UpdateDataSourceResponse');
