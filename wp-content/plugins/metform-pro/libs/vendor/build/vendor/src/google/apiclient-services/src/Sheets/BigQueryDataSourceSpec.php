...
class BigQueryDataSourceSpec extends \MetFormProVendor\Google\Model
{
    public $projectId;
...
\class_alias(BigQueryDataSourceSpec::class, 'MetFormProVendor\\Google_Service_Sheets_BigQueryDataSourceSpec');
