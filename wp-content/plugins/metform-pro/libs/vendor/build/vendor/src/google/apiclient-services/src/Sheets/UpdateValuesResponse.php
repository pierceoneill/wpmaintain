...
class UpdateValuesResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(UpdateValuesResponse::class, 'MetFormProVendor\\Google_Service_Sheets_UpdateValuesResponse');
