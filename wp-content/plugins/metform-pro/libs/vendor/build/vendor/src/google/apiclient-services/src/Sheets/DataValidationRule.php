...
class DataValidationRule extends \MetFormProVendor\Google\Model
{
...
\class_alias(DataValidationRule::class, 'MetFormProVendor\\Google_Service_Sheets_DataValidationRule');
