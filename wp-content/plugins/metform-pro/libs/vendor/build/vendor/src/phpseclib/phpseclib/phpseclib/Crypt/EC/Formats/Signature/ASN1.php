 ...
 */
namespace MetFormProVendor\phpseclib3\Crypt\EC\Formats\Signature;

use MetFormProVendor\phpseclib3\Math\BigInteger;
use MetFormProVendor\phpseclib3\File\ASN1 as Encoder;
use MetFormProVendor\phpseclib3\File\ASN1\Maps\EcdsaSigValue;
/**
 * ASN1 Signature Handler
 *
 * @package Common
