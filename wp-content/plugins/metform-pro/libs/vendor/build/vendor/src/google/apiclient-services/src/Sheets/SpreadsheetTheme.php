...
class SpreadsheetTheme extends \MetFormProVendor\Google\Collection
{
...
\class_alias(SpreadsheetTheme::class, 'MetFormProVendor\\Google_Service_Sheets_SpreadsheetTheme');
