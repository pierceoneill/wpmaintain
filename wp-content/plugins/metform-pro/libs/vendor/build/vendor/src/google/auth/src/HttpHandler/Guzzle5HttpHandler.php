 ...
 */
namespace MetFormProVendor\Google\Auth\HttpHandler;

use Exception;
use MetFormProVendor\GuzzleHttp\ClientInterface;
use MetFormProVendor\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use MetFormProVendor\GuzzleHttp\Promise\Promise;
use MetFormProVendor\GuzzleHttp\Promise\RejectedPromise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('MetFormProVendor\\GuzzleHttp\\Promise\\Promise')) {
