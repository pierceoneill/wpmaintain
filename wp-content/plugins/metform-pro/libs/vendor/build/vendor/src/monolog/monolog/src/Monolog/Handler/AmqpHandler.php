...
use MetFormProVendor\Monolog\Formatter\JsonFormatter;
use MetFormProVendor\PhpAmqpLib\Message\AMQPMessage;
use MetFormProVendor\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
/**
