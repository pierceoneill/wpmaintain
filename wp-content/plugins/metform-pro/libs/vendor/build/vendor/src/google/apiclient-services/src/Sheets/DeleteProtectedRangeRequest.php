...
class DeleteProtectedRangeRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(DeleteProtectedRangeRequest::class, 'MetFormProVendor\\Google_Service_Sheets_DeleteProtectedRangeRequest');
