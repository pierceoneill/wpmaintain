...
class AppendValuesResponse extends \MetFormProVendor\Google\Model
{
...
\class_alias(AppendValuesResponse::class, 'MetFormProVendor\\Google_Service_Sheets_AppendValuesResponse');
