...
class InsertRangeRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(InsertRangeRequest::class, 'MetFormProVendor\\Google_Service_Sheets_InsertRangeRequest');
