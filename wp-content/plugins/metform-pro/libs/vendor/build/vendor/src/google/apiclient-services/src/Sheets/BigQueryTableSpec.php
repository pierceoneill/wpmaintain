...
class BigQueryTableSpec extends \MetFormProVendor\Google\Model
{
    public $datasetId;
    public $tableId;
...
\class_alias(BigQueryTableSpec::class, 'MetFormProVendor\\Google_Service_Sheets_BigQueryTableSpec');
