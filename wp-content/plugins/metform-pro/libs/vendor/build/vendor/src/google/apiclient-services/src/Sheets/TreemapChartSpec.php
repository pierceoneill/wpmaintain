...
class TreemapChartSpec extends \MetFormProVendor\Google\Model
{
...
\class_alias(TreemapChartSpec::class, 'MetFormProVendor\\Google_Service_Sheets_TreemapChartSpec');
