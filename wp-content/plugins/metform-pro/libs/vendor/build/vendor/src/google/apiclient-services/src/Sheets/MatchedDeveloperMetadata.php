...
class MatchedDeveloperMetadata extends \MetFormProVendor\Google\Collection
{
...
\class_alias(MatchedDeveloperMetadata::class, 'MetFormProVendor\\Google_Service_Sheets_MatchedDeveloperMetadata');
