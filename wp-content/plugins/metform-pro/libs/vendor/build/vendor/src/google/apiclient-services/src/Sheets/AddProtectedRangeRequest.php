...
class AddProtectedRangeRequest extends \MetFormProVendor\Google\Model
{
...
\class_alias(AddProtectedRangeRequest::class, 'MetFormProVendor\\Google_Service_Sheets_AddProtectedRangeRequest');
