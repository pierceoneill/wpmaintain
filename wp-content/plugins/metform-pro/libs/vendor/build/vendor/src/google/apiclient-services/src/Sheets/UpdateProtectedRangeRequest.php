...
class UpdateProtectedRangeRequest extends \MetFormProVendor\Google\Model
{
    public $fields;
...
\class_alias(UpdateProtectedRangeRequest::class, 'MetFormProVendor\\Google_Service_Sheets_UpdateProtectedRangeRequest');
