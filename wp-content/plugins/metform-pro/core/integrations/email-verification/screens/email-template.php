                                                    ...
                                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                                      ...
                                                      <table class="wrapper" role="module" data-type="image" border="0"
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              style="font-size:25px; line-height:10px; padding:0px 0px 0px 0px;"
                                                              valign="top" align="center">
                                                              <?php esc_html_e($site_title, 'metform-pro')?>
                                                            </td>
                                                          </tr>
                                                        </tbody>
                                                      </table>
                                                            ...
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 43px"><?php echo esc_html($heading); ?></span>
                                                                </div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 18px"><?php echo esc_html($paragraph)?></span>
                                                                </div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span
                                                                    style="color: #ffbe00; font-size: 18px"><strong><?php esc_html_e('Thank you!', 'metform-pro')?></strong></span>
                                                                </div>
                                                                <div></div>
                                                              </div>
                                                            </td>
