...
class PluginUpdateChecker_3_2 {
	...
	protected function installHooks(){
		...
		load_plugin_textdomain('plugin-update-checker', false, plugin_basename( __DIR__ ) . '/languages');
	...
	public function getUpdateState() {
		...
		if ( isset( $state->update ) && is_object( $state->update ) ) {
	...
	public function initDebugBarPanel() {
		$debugBarPlugin = __DIR__ . '/debug-bar-plugin.php';
