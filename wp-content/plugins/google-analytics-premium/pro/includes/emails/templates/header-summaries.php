				...
				<table border="0" cellpadding="0" cellspacing="0" width="450" class="templateContainer"
					...
					if ( ! empty( $header_image ) ) {
						...
						if ( ! empty( $header_image['2x'] ) ) {
							echo '<img style="max-width:200px;height:auto;"  src="' . esc_url( $header_image['2x'] ) . '" alt="' . esc_attr__( 'Weekly Traffic Summary', 'ga-premium' ) . '" />';
						} else {
							echo '<img style="max-width:300px;height:auto;"  src="' . esc_url( $header_image['url'] ) . '" alt="' . esc_attr__( 'Weekly Traffic Summary', 'ga-premium' ) . '" />';
						}
						echo '</a>';
						echo '</td></tr>';
					}
