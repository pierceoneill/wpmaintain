			...
			<div class="monsterinsights-metabox" id="monsterinsights-metabox-skip-tracking">
				<div class="monsterinsights-metabox-input-checkbox">
					<label class="">
						...
						<span
							class="monsterinsights-metabox-input-checkbox-label"><?php _e( 'Exclude page from Google Analytics Tracking', 'ga-premium' ); ?></span>
					</label>
				</div>
				<div class="monsterinsights-metabox-helper">
					<?php _e( 'Toggle to prevent Google Analytics from tracking this page.', 'ga-premium' ); ?>
				</div>
			</div>
			...
			<?php if ( ! monsterinsights_is_pro_version() ) { ?>
				<div class="monsterinsights-metabox-pro-badge">
                        <span>
                            ...
                            <?php _e( 'This is a PRO feature.', 'ga-premium' ); ?>
                        </span>
