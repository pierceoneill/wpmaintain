<div class="csmm-tile" id="dashboard">
    <div class="csmm-tile-body">
        <div class="csmm-tile-title">Dashboard</div>
        <?php
        ...
        ?>
        <p>Thank you for choosing the <?php echo $plugin_name; ?> plugin! Videos and short tutorials in this section will help you get started.</p>

        <br />
        <?php
        if($signals_csmm_options['track_stats'] == 1){
            ?>
            <div class="csmm-tile-title">Stats</div>

            <div class="csmm-stats-wrapper">
                <?php 
                $total_stats = csmm_stats::get_stats_count();
                $show_placeholder = false;
                if($total_stats<1){
                    $show_placeholder = true;
                }
                echo $show_placeholder?'<div class="csmm-chart-placeholder">Stats will be available once enough data is collected.</div>':'';
                ?>
                <div class="csmm-stats <?php echo $show_placeholder?'csmm-stats-disabled':''; ?>"><canvas id="csmm-chart" style="height: 160px; width: 100%;"></canvas></div>
                <div class="csmm-stats <?php echo $show_placeholder?'csmm-stats-disabled':''; ?> csmm-stats-details"><?php csmm_stats::print_stats(); ?></div>
            </div>
            <?php 
        } 
        ?>
        <div class="csmm-section-content">
            ...
            <?php if (csmm_whitelabel_filter()) { ?>
                ...
                if(csmm_get_rebranding() !== false){
                    ...
                    echo '<p>Our in-house support agents will be happy to answer any questions you have! But, before you email us, we\'d like to turn your attention to our <a href="https://docs.comingsoonwp.com/" target="_blank">detailed online documentation</a> as well as a whole set of <a href="https://docs.comingsoonwp.com/">video tutorials</a>. Still stuck? <a href="#open-beacon">Contact support</a>.<br>Our average response time on weekdays is one hour.</p>';
                }
                ?>
                ...
                <?php
                if(csmm_get_rebranding() === false){
                echo '<div class="home-box"><span>Getting started tutorial</i></span>
